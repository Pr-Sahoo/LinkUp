...
const Login = () => {
    ...
    return (
        <div className='flex justify-center text-black items-center min-h-screen w-full px-4 '>
            <Particles
            ...
            />
            {/* <div className="bg-green-300 p-6 sm:p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-sm lg:max-w-lg" style={{background: "#66A5AD"}}>
            ...
            <div className="flex items-center justify-center w-full min-h-screen px-4 ">
                ...
                <div className="flex w-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg" style={{ background: "#CADCFC" }}>
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage:
                            "url('https://images.unsplash.com/photo-1489743342057-3448cc7c3bb9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHdlbGNvbWUlMjBiYWNrfGVufDB8fDB8fHww')",    
                    ...
                    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                        ...
                        <button className="flex items-center justify-center w-full mt-4 text-gray-600 transition duration-300 transform border rounded-lg hover:bg-gray-50">
                            ...
                            <span className="w-5/6 px-4 py-3 font-bold text-center text-green-300">
                                Login with Google
                            </span>
                        </button>
