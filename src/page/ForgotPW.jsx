...
const ForgotPW = () => {
    ...
    // </div>
        ...
        <section class="bg-white">
            <div class="lg:grid lg:min-h-screen lg:grid-cols-12 md:w-screen md:h-screen sm:h-screen sm:w-screen">
                <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                    ...
                    <div class="hidden lg:relative lg:block lg:p-12">
                        ...
                        <p class="mt-4 leading-relaxed text-white/90">
                            Connect with your friends and close one and enjoy real time chatting
                        </p>
                    </div>
                </section>
                ...
                >
                    <div class="max-w-xl lg:max-w-3xl">
                        <div class="relative -mt-16 block lg:hidden">
                            <a
                                class="inline-flex size-16 items-center justify-center rounded-full bg-blue-200 text-blue-600 sm:size-20"
                                href="#"
                            >
                                <span class="sr-only">Home</span>
                                <svg
                        ...
                        <form action="#" class="mt-8 grid grid-cols-6 gap-6" onSubmit={handleReset}>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input
                                    ...
                                    id="LastName"
                                    name="last_name"
                                    class="mt-1 w-full rounded-md p-4 border-gray-200 bg-white text-sm text-gray-700 shadow-xs"
                                />
                            </div> */}
                            ...
                            <div class="col-span-6">
                                ...
                                <input
                                    ...
                                    id="Email"
                                    name="email"
                                    class="mt-1 w-full rounded-md border-gray-200 bg-white text-lg text-gray-700 py-2 shadow-xs"
                            ...
                            <div class="col-span-6">
                                <label for="MarketingAccept" class="flex gap-4">
                                    <input
                                        ...
                                        class="size-5 rounded-md border-blue-500 bg-white shadow-xs"
                                    />
